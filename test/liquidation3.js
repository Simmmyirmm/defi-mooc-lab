...
describe("Question 3: test liquidation on another account", function () {
  ...
  it("TEST Liquidation 6,660 USDC", async function (input = "6660") {
    ...
    const gasPrice = 0;
    const debtInUSDC = ethers.utils.parseUnits(input, 6);
  ...
  it("TEST Liquidation 7,777 USDC", async function (input = "7777") {
    console.log("\nLiquidation " + input + " USDC");
    await network.provider.request({
      method: "hardhat_reset",
      params: [
  ...
  it("TEST Liquidation 8,888 USDC", async function (input = "8888") {
    console.log("\nLiquidation " + input + " USDC");
    await network.provider.request({
      method: "hardhat_reset",
      params: [
  ...
  it("TEST Liquidation 9,999 USDC", async function (input = "9999") {
    console.log("\nLiquidation " + input + " USDC");
    await network.provider.request({
      method: "hardhat_reset",
      params: [
